...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="about-text" data-aos="fade-up">
            <h1 style="font-size: 35px;">Welcome to our <i class="fa fa-h-square" style="color:dodgerblue;"></i>ealth center</h1>
...
<div  class="viewhosp" style="float: left; color: black;"><a href="hospitals.php"><h3>View more hospitals....</h3></a></div>
</div>
</section>
